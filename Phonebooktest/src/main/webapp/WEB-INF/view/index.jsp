...
main{display:flex;height:600px;width:100%;border:5px solid blue}
...
function update(idx){
	...
	document.querySelector("#hp1").value="";
	document.querySelector("#memo1").value="";
}
